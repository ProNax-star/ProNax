...
function ShortItem({
  ...
  return (
    <div ref={stageRef} className="relative isolate h-full w-full overflow-hidden bg-black text-white select-none">
      ...
      <div
        className="absolute right-2 z-40 flex flex-col items-center gap-3.5 bottom-[calc(env(safe-area-inset-bottom,0px)+66px)] md:bottom-5 md:right-3"
      >
      ...
      <div
        className="pointer-events-none absolute left-0 z-20 w-full pb-0 pl-3 pr-[76px] bottom-[calc(env(safe-area-inset-bottom,0px)+66px)] md:bottom-5 md:pl-4 [&_a]:pointer-events-auto [&_button]:pointer-events-auto"
      >
      ...
      <div className="absolute inset-x-0 z-30 h-[2px] bg-white/20 bottom-[calc(env(safe-area-inset-bottom,0px)+56px)] md:bottom-0">
