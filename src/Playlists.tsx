...
import { PlaylistGridSkeleton } from '@/components/NeonSkeleton';
  ...
  return (
    <div className="flex-1 min-h-screen px-3 lg:px-6 py-4">
      ...
      {loading ? (
        ...
        <SignInGate
          inline
          title="Sign in to build playlists"
          description="Create playlists and organise your favourite videos across all your devices."
        />
      ) : items.length === 0 ? (
