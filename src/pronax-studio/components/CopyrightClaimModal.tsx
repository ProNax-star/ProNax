...
export const CopyrightClaimModal: React.FC<CopyrightClaimModalProps> = ({
  ...
  const claim = video?.copyrightClaimDetails || {
    id: "cclaim-default",
    videoId: video?.id ?? "",
    claimedTrack: "Chill Lofi Synth Loop 04",
    claimOwner: "Sony Music Entertainment / Content ID",
    claimType: "Audio track Content ID match",
    timestampRange: "02:14 - 05:30",
    channelImpact: "Not affected (No channel strikes)",
    monetizationImpact: "Ad revenue shared or paid to copyright owner",
    status: "Active claim",
  };
  ...
  const [selectedReplacementTrack, setSelectedReplacementTrack] = useState<string | null>("Cybernetic Horizon");
  const [resolvingAction, setResolvingAction] = useState<string | null>(null);

  const mockLibraryTracks = [
    { title: "Cybernetic Horizon", genre: "Synthwave", duration: "03:45", artist: "Pronax Studio Free" },
    { title: "Lo-Fi Coding Beats", genre: "ChillHop", duration: "04:12", artist: "Pronax Studio Free" },
    { title: "Acoustic Morning", genre: "Folk", duration: "03:20", artist: "Pronax Studio Free" },
    { title: "Neon Midnight", genre: "Electronic", duration: "03:50", artist: "Pronax Studio Free" },
  ];
