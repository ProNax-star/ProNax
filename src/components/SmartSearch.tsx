  ...
  return (
    <>
      <button
        ...
        className="group relative flex items-center gap-2.5 px-4 py-2 rounded-full text-xs text-muted-foreground hover:text-white transition-all duration-300 max-w-xs w-48 md:w-72 backdrop-blur-xl bg-gradient-to-r from-primary/10 via-secondary/5 to-accent/10 border border-primary/25 hover:border-primary/60 shadow-[inset_0_1px_0_hsla(190,100%,90%,0.15),0_4px_20px_-6px_hsl(var(--glow-primary)/0.35)] hover:shadow-[inset_0_1px_0_hsla(190,100%,90%,0.2),0_6px_28px_-6px_hsl(var(--glow-primary)/0.6)] hover:scale-[1.02]"
      >
        <Search className="w-3.5 h-3.5 text-primary drop-shadow-[0_0_6px_hsl(var(--glow-primary))]" />
        <span className="truncate tracking-wide">Search videos, creators…</span>
        <span className="ml-auto hidden md:inline text-[9px] px-1.5 py-0.5 rounded border border-primary/30 text-primary/80 font-mono">⌘K</span>
      </button>
