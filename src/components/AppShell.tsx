      ...
      <SidebarProvider>
        <div className="min-h-screen flex w-full">
          ...
          <div className="flex-1 flex flex-col min-w-0">
            {!isStudioRoute && (
              <div className="lg:hidden sticky top-0 z-50 glass-strong border-b border-border/30 h-12 flex items-center justify-between px-3 gap-2">
                <span className="text-sm font-display font-bold text-primary text-glow shrink-0">PRO NAX</span>
                <SmartSearch />
